...
export default function AuthPage({ onClose, onSuccess, initialMode = 'signin' }: AuthPageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="h-[100dvh] min-h-[500px] w-full flex items-center justify-center p-6 py-12 relative z-10 overflow-y-auto">
        <motion.div 
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="w-full max-w-[320px] bg-[#0A0A0A]/95 backdrop-blur-2xl border border-[#2A2A2A] rounded-2xl p-6 sm:p-8 relative shadow-2xl"
        >
          {/* Background Glow */}
