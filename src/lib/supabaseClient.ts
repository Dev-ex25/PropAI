    ...
    switch (table) {
        ...
        return [
          {
            ...
            email: 'j.carter@realtormail.com',
            phone: '+1 (555) 302-8491',
            budget: 1250000,
            preferred_location: 'Rivertown',
          ...
          },
          {
            ...
            email: 'monica.reyes@homespot.co',
            phone: '+1 (555) 918-3829',
            budget: 2350000,
            preferred_location: 'Lakeview',
            assigned_user_id: 'mock-user-alex',
          ...
          {
            id: 'c3',
            full_name: 'Diana Brooks',
            email: 'diana.b@remaxrealty.com',
            phone: '+1 (555) 831-2741',
            budget: 950000,
            preferred_location: 'Sunnyvale',
            assigned_user_id: 'mock-user-alex',
            pipeline_stage: 'new',
          ...
          },
          {
            ...
            email: 'tyler.bennett@urbanestates.io',
            phone: '+1 (555) 283-4921',
            budget: 1850000,
            preferred_location: 'Meadowbrook',
            assigned_user_id: 'mock-user-alex',
            pipeline_stage: 'new',
            created_at: new Date().toISOString()
          }
      ...
      case 'properties':
        return [
          {
            id: '1',
            title: '123 Elm Street',
            description: 'Elite modern estate with custom finishes.',
            price: 1250000,
            property_type: 'House',
            location: 'Rivertown',
          ...
          },
          {
            ...
            description: 'Stunning property bordering Lakeview private key.',
            price: 2350000,
            property_type: 'Villa',
            location: 'Lakeview',
            realtor_id: 'mock-user-alex',
          ...
          {
            id: '3',
            title: '654 Cedar Boulevard',
            description: 'Cozy and spacious contemporary suite inside Sunnyvale hills.',
            price: 950000,
            property_type: 'Condo',
            location: 'Sunnyvale',
            realtor_id: 'mock-user-alex',
            image_url: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=300&q=80',
            created_at: new Date().toISOString()
          },
          {
            id: '4',
            title: '135 Willow Way',
            description: 'Suburban masterpiece complete with pool and master suite.',
            price: 1850000,
            property_type: 'House',
            location: 'Meadowbrook',
            realtor_id: 'mock-user-alex',
            image_url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=300&q=80',
            created_at: new Date().toISOString()
          }
        ];
      case 'conversations':
        return [
          {
            id: 'conv1',
            lead_id: 'c1',
            message_content: "Hello, I'd like to book an exploration session for Elm Street.",
            sender_type: 'lead',
          ...
          },
          {
            id: 'conv2',
            lead_id: 'c1',
            message_content: "Absolutely. I am checking availability slots for tomorrow at 2 PM.",
            sender_type: 'ai',
            created_at: new Date().toISOString()
          }
        ];
        ...
        return [
          {
            ...
            assigned_user_id: 'mock-user-alex',
            lead_id: 'c1',
            task_title: 'Confirm showing appointment for 2 PM tomorrow',
            due_date: 'SEPTEMBER 12, 2025',
            completed: false,
          ...
          },
          {
            ...
            assigned_user_id: 'mock-user-alex',
            lead_id: 'c2',
            task_title: 'Follow up with buyer after showing',
            due_date: 'AUGUST 22, 2025',
            completed: false,
            category: 'Pending',
            description: "Gather feedback from Sarah's visit to our Platinum estate."
          },
          {
            id: 't3',
            assigned_user_id: 'mock-user-alex',
            lead_id: 'c3',
            task_title: 'Follow up with buyer leads from open house',
            due_date: 'AUGUST 22, 2025',
            completed: false,
            category: 'Pending',
            description: 'Review signatures on the guest register.'
          },
          {
            id: 't4',
            assigned_user_id: 'mock-user-alex',
            lead_id: 'c4',
            task_title: 'Update listing photos for 1234 Sunset Blvd',
            due_date: 'JUNE 15, 2025',
            completed: false,
            category: 'In Progress',
            description: 'Replace standard photos with professional shoots.'
          }
        ];
      case 'ai_memory':
        return [
          {
            id: 'mem1',
            entity_id: 'c1',
            raw_content: 'Lead Jason Carter likes high-ceiling modern properties in Rivertown.'
          }
        ];
      case 'notifications':
        return [
          {
            ...
            content: 'New high-intent lead Jason Carter registered.',
            read_status: false
          }
        ];
      case 'subscriptions':
